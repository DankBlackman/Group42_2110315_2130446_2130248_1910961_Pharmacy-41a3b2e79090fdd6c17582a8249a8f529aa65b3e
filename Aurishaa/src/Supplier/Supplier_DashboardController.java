 ...
 * @author Dell
 */
public class Supplier_DashboardController implements Initializable {
    ...
    @FXML
    private void supplierInformationButtonMouseOnClicked(ActionEvent event) throws IOException {
        Parent mainSceneParent = FXMLLoader.load(getClass().getResource("/Supplier/Supplier_Information.fxml"));
